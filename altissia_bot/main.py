...
def run_bot_interactive(headless: bool = False, unit_url: str = None):
    ...
    with sync_playwright() as p:
        ...
        try:
            ...
            print_info("Appuyez sur Entrée une fois sur la page de l'exercice (là où vous voyez les questions)...")
            input()
            ...
            try:
                ...
                print_info("Assurez-vous d'être sur la page d'un exercice (là où vous voyez les questions)")
                return
...
Exemples d'utilisation :
  ...
  python main.py --unit-url <URL>          # Avec URL d'unité spécifique
    ...
    parser.add_argument(
        '--auto',
        action='store_true',
        help='Mode automatique (résout l\'exercice sans interaction)'
    )
    ...
    parser.add_argument(
        ...
        type=int,
        default=1,
        help='Numéro de l\'exercice en mode auto (défaut: 1)'
    )
    
    parser.add_argument(
        '--headless',
        action='store_true',
        help='Lance le navigateur en mode headless (invisible)'
    )
    
    parser.add_argument(
        '--unit-url',
        type=str,
        help='URL de l\'unité Altissia'
    )
